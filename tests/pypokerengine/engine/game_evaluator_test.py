...
import ai_project_poker.engine.hand_evaluator
...
class GameEvaluatorTest(BaseUnitTest):
  ...
  def test_judge_without_allin(self):
    ...
    with patch('ai_project_poker.engine.hand_evaluator.HandEvaluator.eval_hand', side_effect=mock_eval_hand_return):
