import ai_project_poker.utils.card_utils as U
...
class CardUtilsTest(BaseUnitTest):
    ...
    def test_montecarlo_simulation(self):
        ...
        with patch('ai_project_poker.utils.card_utils._fill_community_card', side_effect=[mock_return]):
        ...
        with patch('ai_project_poker.utils.card_utils._pick_unused_card', side_effect=mock_return):
